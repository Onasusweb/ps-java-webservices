...
public class Manufacturer implements Serializable {
    ...
    @XmlElement(name = "short_description", required = false)
    ...
    protected ManufacturerAssociations associations;
    ...
    public ManufacturerAssociations getAssociations() {
        return associations;
    }
    
    public void setAssociations(ManufacturerAssociations associations) {

...
public class PrestashopStockAvailables implements Serializable {
    
    @XmlElementWrapper(name="stock_availables", required = false)
    @XmlElement(name = "stock_available", required = false)
    private List<StockAvailable> stockAvailables;

...
public class PrestashopSupplyOrderDetails implements Serializable {
    
    @XmlElementWrapper(name="supply_order_details", required = false)
    @XmlElement(name = "supply_order_detail", required = false)

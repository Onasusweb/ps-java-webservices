...
public class PrestashopOrderInvoices implements Serializable {
    
    @XmlElementWrapper(name="order_invoices", required = false)
    @XmlElement(name = "order_invoice", required = false)

...
public class PrestashopCustomerMessages implements Serializable {
    
    @XmlElementWrapper(name="customer_messages", required = false)
    @XmlElement(name = "customer_message", required = false)

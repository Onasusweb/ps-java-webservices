...
public class PrestashopSupplyOrders implements Serializable {
    
    @XmlElementWrapper(name="supply_orders", required = false)
    @XmlElement(name = "supply_order", required = false)

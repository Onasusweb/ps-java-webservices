...
public class ShopGroup implements Serializable {
    ...
    @XmlElement(name = "share_customer", required = false)
    protected Integer shareCustomer;
    
    @XmlElement(name = "share_order", required = false)
    protected Integer shareOrder;
    
    @XmlElement(name = "share_stock", required = false)
    protected Integer shareStock;
